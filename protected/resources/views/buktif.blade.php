...
<body>
    ...
    <div class="container">
        ...
        <div class="kop">
            <H1 class="pt-0 mb-0">BUKTI PENDAFTARAN LEMBAGA</H1>
            <H3 class="pt-0">DI NAUNGAN YAYASAN MIFTAHUL ULUM AL-YASINI</H3>
        </div>
        ...
        <table>
            <tbody>
                ...
                <tr>
                    <td scope="row">No. Pendaftaran</td>
            ...
            <table class="table" width="720px" style="margin: 0px 30px 0px 50px;">
                <tbody>
                    <tr>
                        ...
                        <td>Pasuruan, {{$d->tgl_bayar->format('d F Y')}} <br></td>
                    </tr>
                    <tr>
